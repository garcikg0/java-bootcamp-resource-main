...
public class Main {
    ...
    public static void printResult() {
        ...
        Team slytherine = game.getTeam("SLYTHERIN");
        Team winner = game.getScore(gryffindor) > game.getScore(slytherine) ? gryffindor : slytherine;
        System.out.println("\nGRYFFINDOR: " + game.getScore(gryffindor) + " SLYTHERIN: " + game.getScore(slytherine));
